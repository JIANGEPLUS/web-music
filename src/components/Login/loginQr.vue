<template>
  <div class="QR-div">
    ...
    <el-button class="refreshQr" type="primary" size="small" @click="getQrKey">刷新二维码</el-button>
    <el-button class="checkQr" type="primary" size="small" @click="checkQr">验证登录</el-button>
  </div>
</template>
...
export default {
  ...
  methods: {
    //二维码 key 生成接口
     async getQrKey(){
      const {data:res}=await this.$http.get('/login/qr/key',{params:{timestamp: Date.now()}})
